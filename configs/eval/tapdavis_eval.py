...
exp_name = 'res18_d1_tapdavis_eval'
...
val_pipeline = [
    dict(type='Resize', scale=(512, 320), keep_ratio=False, keys='video'),
...
data = dict(
    ...
    train=
            ...
            root='/home/sist/lirui//dataset/YouTube-VOS',
            list_path='/home/sist/lirui//dataset/YouTube-VOS/2018/train',
...
log_config = dict(
    ...
    hooks=[
        ...
        # dict(type='WandbLoggerHook_Custom', init_kwargs=dict(project='video_correspondence', name=f'{exp_name}'))
    ])
...
log_level = 'INFO'
work_dir = f'/home/sist/lirui//expdir/mmpt//{exp_name}'
