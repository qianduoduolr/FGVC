...
from .utils import split_feature, merge_splits, feature_add_position
...
class GMFeatureTransformer(nn.Module):
    def __init__(self,
                 num_layers=4,
                 d_model=256,
                 nhead=1,
        ...
        super(GMFeatureTransformer, self).__init__()
    ...
    def forward(self, feature0, feature1,
        ...
        if len(feature1.shape) == 5:
            
            b_, _, t = feature1.shape[:3]
            feature0 = feature0[:,None].repeat(1, t, 1, 1, 1).flatten(0,1)
            feature1 = feature1.transpose(1,2).flatten(0,1)
        ...
        if self.pos_emb:
            feature0, feature1 = feature_add_position(feature0, feature1, attn_num_splits, self.d_model)
        ...
        if mt:
            feature0 = feature0.reshape(b_, t, c, h, w)[:,0]
            feature1 = feature1.reshape(b_, t, c, h, w).transpose(1,2)
