...
class WandbLoggerHook_Custom(LoggerHook):
    ...
    def __init__(self,
                 ...
                 with_step=True,
                 log_artifact=False,
                 out_suffix=('.log.json', '.log')):
        super(WandbLoggerHook_Custom, self).__init__(interval, ignore_last,
                                              reset_flag, by_epoch)
        self.import_wandb()
    ...
    def before_run(self, runner):
        super(WandbLoggerHook_Custom, self).before_run(runner)
